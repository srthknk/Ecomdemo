...
export default function Dashboard() {
    ...
    const dashboardCardsData = [
        { title: 'Total Products', value: dashboardData.totalProducts, icon: ShoppingBasketIcon, color: 'bg-blue-100 text-blue-700' },
        ...
        { title: 'Total Orders (Active)', value: dashboardData.totalOrders, icon: TagsIcon, color: 'bg-orange-100 text-orange-700' },
        { title: 'Total Ratings', value: dashboardData.ratings.length, icon: StarIcon, color: 'bg-purple-100 text-purple-700' },
    ]
