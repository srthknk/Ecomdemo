        ...
        <div className="mt-8 p-6 bg-gradient-to-br from-slate-50 to-slate-100 border border-slate-200 rounded-lg">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
                ...
                <div className={`rounded-lg p-4 border-2 transition-all ${
                    ...
                    <div className="flex items-center justify-between mb-2">
                        <AlertTriangle size={20} className={inventory.outOfStockCount > 0 ? 'text-red-600' : 'text-green-600'} />
                ...
                <div className={`rounded-lg p-4 border-2 transition-all ${
                    ...
                    <div className="flex items-center justify-between mb-2">
                        <TrendingUp size={20} className={inventory.lowStockCount > 0 ? 'text-orange-600' : 'text-slate-600'} />
                        <span className={`text-xs font-semibold px-2 py-1 rounded-full ${
                            inventory.lowStockCount > 0
