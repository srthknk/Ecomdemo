                ...
                <p>Address</p>
                {
                    selectedAddress ? (
                        ...
                        <div>
                            ...
                            <button className='flex items-center gap-1 text-slate-600 mt-1 btn-animate btn-secondary transition-all duration-300' onClick={() => setShowAddressModal(true)} >Add Address <PlusIcon size={18} /></button>
                        </div>
                    )
                }
            </div>
